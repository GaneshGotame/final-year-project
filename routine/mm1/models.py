...
time_slots = (
    ('7:15 - 8:55', '7:15 - 8:55'),
    ('8:55 - 10:35', '8:55 - 10:35'),
    ('10:35 - 11:25', '10:35 - 11:25'),
    ('11:25 - 1:05', '11:25 - 1:05'),
    ('1:05 - 1:55', '1:05 - 1:55'),
...
class Room(models.Model):
    ...
    seating_capacity = models.IntegerField(default=48)
...
class Course(models.Model):
    course_number = models.CharField(max_length=8, primary_key=True)
...
class Selectsemester(models.Model):
    select_semester_id = models.CharField(max_length=25, primary_key=True)
    ...
    def set_room(self, room):
        selectsemester = Selectsemester.objects.get(pk = self.select_semester_id)
        selectsemester.room = room
        selectsemester.save()

    def set_meetingTime(self, meetingTime):
        selectsemester = Selectsemester.objects.get(pk = self.select_semester_id)
        selectsemester.meeting_time = meetingTime
        selectsemester.save()

    def set_instructor(self, instructor):
        selectsemester = Selectsemester.objects.get(pk=self.select_semester_id)
        selectsemester.instructor = instructor
        selectsemester.save()
